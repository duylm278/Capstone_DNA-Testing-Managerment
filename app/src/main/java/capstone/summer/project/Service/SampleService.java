...
public class SampleService {
    ...
    static final String URL_API = ConstantManager.HOST+"api/" + ConstantManager.API.GET_SAMPLE;

    public static void getSampleByCaseID(Activity context, String caseID, final VolleyCallback callback) {

        final String URL = URL_API +"/ByCaseID/"+caseID;
        ...
        StringRequest objectRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            List<Sample> samples= om.readValue(response,new TypeReference<List<Sample>>(){});
    ...
    public static void getSampleByID(Context context, int  id, final VolleyCallback callback) {
        ...
        StringRequest objectRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            Sample sample= om.readValue(response,Sample.class);
