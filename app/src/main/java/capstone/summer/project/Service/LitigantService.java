...
public class LitigantService {
    static final String TAG = "LitigantService";
    static final ObjectMapper om = new ObjectMapper().configure(MapperFeature.ACCEPT_CASE_INSENSITIVE_PROPERTIES, true);
    static final String URL_API = ConstantManager.HOST+"api/" + ConstantManager.API.GET_LITIGANT;
    static final Gson gson = new Gson();

    public static void getAllLitigant(Context context, final VolleyCallback callback) {
        ...
        StringRequest objectRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            List<Litigant> litigants= om.readValue(response,new TypeReference<List<Litigant>>(){});
                            callback.onSuccess(litigants);
                        } catch (Exception ex) {
                            ex.printStackTrace();
