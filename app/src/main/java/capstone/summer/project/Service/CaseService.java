...
public class CaseService {
    static final String TAG = "CaseService";
    static final ObjectMapper om = new ObjectMapper().configure(MapperFeature.ACCEPT_CASE_INSENSITIVE_PROPERTIES, true);
    static final String URL_API = ConstantManager.HOST+"api/" + ConstantManager.API.GET_CASE;
    static final Gson gson = new Gson();

    public static void getAllCase(Context context, final VolleyCallback callback) {
        ...
        StringRequest objectRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            List<Case> caseList= om.readValue(response,new TypeReference<List<Case>>(){});
